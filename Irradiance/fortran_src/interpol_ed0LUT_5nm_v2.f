     	...
     	SUBROUTINE interpol_ed0LUT_5nm_v2(LUT, 
     &thetas, ozone, taucl,SurfaceAlb, ed)
!
        ...
        do i=1,2
                ...
                do j=1,2
                        ...
                        do k=1,2
                           ztaucl = itaucl+(k-1)
                           do l=1,nwl
                                ed_tmp4(l,i,j,k)=(1.-ralb)
     &*LUT(l,zthetas, zozone,ztaucl, ialb)
     &+ ralb * LUT(l,zthetas, zozone, ztaucl, ialb+1)
