...
function [type,ialbedo,talbedo] = f_get_albedo_v2(doy,sic,snow)

% Parameter definitions
calbedo = 0.85; % cold snow albedo
mslope = 0.63; % slope of albedo vs. sic for melting ice/snow
walbedo = 0.07; % open water albedo, intercept of albedo vs. sic linear relationship
...
melting = ~coldsnow;
type(melting) = 2;
talbedo(melting) = walbedo + mslope.*sic(melting);
