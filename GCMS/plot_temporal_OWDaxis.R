...
dfi$OWD <- dfi$OWD + 1 # Correct phase distortion
...
lines(spline(dfi$OWD, dfi$fdms, n = 201, method = 'natural'), col = col.fdms.line, lwd = 2)
...
lines(spline(dfi$OWD, dfi$dms, n = 201, method = 'natural'), col = col.dms.line, lwd = 2)
points(df$OWD, df$dmspt * f.dmspt, ylim = yldmspt, col = col.dmspt, pch = 20)
lines(spline(dfi$OWD, dfi$dmspt * f.dmspt, n = 201, method = 'natural'), col = col.dmspt.line, lwd = 2)
...
lines(spline(dfi$OWD, dfi$par_srd * f.par, n = 201, method = 'natural'), col = col.par.line, lwd = 2)
...
lines(spline(dfi$OWD, dfi$cpsmooth1 * f.cp, n = 201, method = 'natural'), col = col.cp.line, lwd = 2)
...
lines(spline(dfi$OWD, dfi$sst, n = 201, method = 'natural'), col = col.sst.line, lwd = 2)
axis(1, labels = F, tcl = -0.3, at = xticks)
axis(2, labels = T, tcl = -0.3, at = seq(-2,4,2))
points(df$OWD, df$sal * 2 - 64, ylim = yldmspt, col = col.sss, pch = 20)
lines(spline(dfi$OWD, dfi$sal  * 2 - 64, n = 201, method = 'natural'), col = col.sss.line, lwd = 2)
...
# lines(spline(dfi$OWD, dfi$par_srd, n = 201, method = 'natural'), col = col.par.line, lwd = 2)
# axis(1, labels = F, tcl = -0.3, at = xticks)
# axis(2, labels = T, tcl = -0.3, at = seq(0,25,5))
# points(df$OWD, df$NO3 * f.no3, col = col.sss, pch = 20)
# lines(spline(dfi$OWD, dfi$NO3 * f.no3, n = 201, method = 'natural'), col = col.sss.line, lwd = 2)
...
lines(spline(dfi$OWD, dfi$hBD_m, n = 201, method = 'natural'), col = col.hBD.line, lwd = 2)
axis(1, labels = T, tcl = -0.3, at = xticks)
axis(2, labels = T, tcl = -0.3)
points(df$OWD, df$mld03, col = col.mld, pch = 20)
lines(spline(dfi$OWD, dfi$mld03, n = 201, method = 'natural'), col = col.mld.line, lwd = 2)
points(df$OWD, df$dbm, col = col.dbm, pch = 20)
lines(spline(dfi$OWD, dfi$dbm, n = 201, method = 'natural'), col = col.dbm.line, lwd = 2)
points(df$OWD, df$Nitracline_m, col = col.ncline, pch = 20)
lines(spline(dfi$OWD, dfi$Nitracline_m, n = 201, method = 'natural'), col = col.ncline.line, lwd = 2)
grid(nx = NULL, ny = NA)

# Legend: depth of hBD, mld_0.03, dbm
legend(x = -5, y = 25, pch = 20,
       cex = 0.9,
       lwd = rep(2,3),
       legend = c('hBD','mLD','DBM','NO3-cline'),
