...
for (p in names(xvarS)) {
  ...
  text(0.5*xl[2], 3*yl[1], paste0("rs = ",round(cor(tp$x, tp$y, "pairwise", "spear"), 2)), cex = 1.2)
  text(0.5*xl[2], 2*yl[1], paste0("rp = ", round(cor(tp$x, tp$y, "pairwise", "pears"), 2)), cex = 1.2)
  text(0.45*xl[2], (4/3)*yl[1], paste0("n = ", round(length(tp$x), 0)), cex = 1.2)
